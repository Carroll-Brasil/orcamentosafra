...
function ShaderPlane() {
  ...
  // Compute the visible size at the plane's Z so it fully covers the screen
  const v = viewport.getCurrentViewport(camera, [0, 0, -0.5]);

  return (
    <mesh ref={meshRef} position={[0, 0, -0.5]} scale={[v.width, v.height, 1]}>
      {/* Unit plane scaled to current viewport for full-bleed coverage */}
